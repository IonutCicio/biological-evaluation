...
% ["DatabaseObject", "PhysicalEntity", "Trackable", "Deletable", "Polymer"]
% ["DatabaseObject", "PhysicalEntity", "EntitySet", "Trackable", "Deletable", "DefinedSet"]
% ["DatabaseObject", "PhysicalEntity", "EntitySet", "Trackable", "Deletable", "CandidateSet"]
% labels of species


\begin{definition}[Biochemical network] 
    A biochemical network $G$ is a tuple $(S, R, C, E, \sigma)$ where 
    \begin{itemize}
        % TODO: possibly not disjoint
        % TODO: species instead of "physical entity", like, seariously?
        % TODO: reaction instead of "reaction like event", like, seariously?
        % TODO: specify the species (in the sense of "human" etc..)
        ...
        \item $E \subseteq S \times R \times T$ is the set of relationships between j
            species and reactions
